...
<html>
<head>
<link rel="stylesheet" type="text/css" href="<%= cp %>/resources/css/movie.css?ver=293" />
...
<script src="<%= cp %>/resources/js/Index.js?ver=12623"></script>
...
<script src="<%= cp %>/resources/js/design-1.0.min.js?ver=3"></script>
