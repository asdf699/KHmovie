        ...
        <div class="bnBxMain">
            <div>
                ...
                <!-- javascript에서 그림 변환시켜줌 -->
                                ...
                                <img src="<%= cp %>/resources/upload/movie/main_banner/${banner.banner_footer}" style="width:980;height:180;border:0px">
            </div>
        </div>
    </div>
    <!--// 배너 -->
			        ...
			        <div class="wrap_banner">
				      ...
				      <!-- javascript에서 그림변환시켜줌 -->
                               <!--  <script type="text/javascript" src="http://nvapi.feeldmc.com/ad/p/in/v1_0/imp?slotid=stw_lottelotte_21"></script> -->
                                ...
                                <img src="<%= cp %>/resources/upload/movie/main_banner/${banner.banner_footer1}" style="width:980;height:240;border:0px"></div>
			        </div>
		        </div>
		        </div> 
</body>
