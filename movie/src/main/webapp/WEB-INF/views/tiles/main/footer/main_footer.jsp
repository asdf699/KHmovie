        ...
        <div class="bnBxMain">
            <div>
                ...
                <!-- javascript에서 그림 변환시켜줌 -->
                                ...
                                <img src="<%= cp %>/resources/upload/movie/main_footer/${bannerselect.banner_footer}" style="width:980;height:180;border:0px">
            </div>
        </div>
    </div>
    <!--// 배너 -->
			        ...
			        <div class="wrap_banner">
				      ...
				      <!-- javascript에서 그림변환시켜줌 -->
                               <!--  <script type="text/javascript" src="http://nvapi.feeldmc.com/ad/p/in/v1_0/imp?slotid=stw_lottelotte_21"></script> -->
                                ...
                                <img src="<%= cp %>/resources/upload/movie/main_footer/${bannerselect.banner_footer1}" style="width:980;height:240;border:0px"></div>
			        </div>
		        </div>
		        ...
		        <div class="footer_inner">
                    ...
                    <div class="footer_tit">
                        ...
                        <div class="footer_box">
                           <!--  <a href="javascript:void(0);" class="ui_fold_btn" title="패밀리 사이트 선택">Family Site</a>
                    ...
                    <ul class="footer_link">
                        <li>
<a href="" title="회원약관">회원약관</a></li>
<li class="active">
<a href="" title="개인정보처리방침">개인정보처리방침</a></li>
<li>
<a href="" title="이메일무단수집거부">이메일무단수집거부</a></li>
<li>
<a href="" title="영상정보처리기기 운영∙관리방침">영상정보처리기기 운영∙관리방침</a></li>
<li>
<a href="" title="L.POINT회원안내">L.POINT회원안내</a></li>
<li>
<a href="" title="배정기준">배정기준</a></li>
<li>
<a href="" title="채용안내" target="_blank">채용안내</a></li>
<li>
<a href="" title="광고/임대문의" target="_blank">광고/임대문의</a></li>
<li>
<a href="" title="기업정보" target="_blank">기업정보</a></li>
                ...
                <div class="footer_Awrap">
                    <ul class="footer_award">
                        <!-- 0324 추가 -->
                        <li><img src="<%= cp %>/resources/upload/movie/main_footer/Footer_award01_NCSI.gif" alt="NCSI 영화관 부문 2년 연속 1위"></li><!--20170323 sunho alt 값 이미지 수정-->
                        <!-- //0324 추가 -->
                        <!-- 
                        <!-- 수정 20171109 -->
						<li><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award01.gif" alt="KCSI 영화관부문 5년 연속 1위(총10회)"></li>
						<li><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award02.gif" alt="KS-SQI 영화관부문 6년 연속 1위(총9회)"></li>
						<!-- 수정 20171109 -->
                        <li><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award03.gif" alt="올해의 브랜드대상 영화관 부문 10년 연속 1휘"></li>
                        <!-- //0314 수정 -->
                        <li><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award04.gif" alt="그린스타 영화관 부문 4년 연속 1위"></li>
                        <!-- 0310 alt 수정 -->
                        <li><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award10.gif" alt="대한민국 브랜드 스타 영화관 부문 1위"></li>
                        <!-- 0407 수정 -->
                        <li><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award07.gif" alt="가족친화 인증기업 선정"></li>
						<!--20170717  sunho  웹접근성 인증마크 링크 수정 -->
                        <li><a title="새창" href="http://www.wa.or.kr/board/list.asp?BoardID=0006" target="_blank"><img src="<%= cp %>/resources/upload/movie/main_footer/footer_award08.gif" alt="(사)한국장애인단체총연합회 한국웹접근성인증평가원 웹 접근성 우수사이트 인증마크(WA인증마크)"></a></li>
